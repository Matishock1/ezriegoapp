...
class AppTheme {
  ...
  static final ThemeData temaLight = ThemeData.light().copyWith(
      // iconTheme: IconThemeData(color: ColoresPediatria.iconos),
      // primaryColor: ColoresPediatria.iconos,
      textTheme: TextTheme(
    ...
    displaySmall: GoogleFonts.nunito(
        ...
        color: ColorSettings.negro,
        letterSpacing: 0
        // color: ColoresPediatria.bodyText1,
        ),
    // headlineMedium: GoogleFonts.nunito(
    //     fontSize: 13,
    //     color: ColorSettings.textoSubrayado,
    ...
    headlineSmall: GoogleFonts.nunito(
      ...
      letterSpacing: 0.15,
      fontWeight: FontWeight.bold,
      // color: ColoresPediatria.textoTitulo,
    ),
    titleLarge: GoogleFonts.nunito(
        ...
        letterSpacing: 0,
        color: ColorSettings.negro
        // color: ColoresPediatria.bodyText3
        ),
